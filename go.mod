module github.com/PastureStack/kubernetes-agent
...
require (
	...
	github.com/rancher/go-rancher v0.1.1-0.20170928163921-463b431ca017
...
replace github.com/rancher/go-rancher-metadata => ./third_party/go-rancher-metadata
